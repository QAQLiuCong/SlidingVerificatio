<template>
     <div id="slider">
        ...
        <div class="drag_text" :class="{slidetounlock:slidetounlock}" onselectstart="return false;" unselectable="on">{{slidertext}}</div>
        <div class="handler handler_bg"></div>
    </div>
</template>
<script>
    import "../assets/lib/SlidingVerificatio";
    export default {
        data () {
            return {
                slidetounlock:true,
        ...
        mounted() {
            ...
            new S({
                id:'slider',
                complete:function(){
                    that.slidetounlock=!that.slidetounlock;
                    that.slidertext='验证通过';
                }
            }); 
        },
    }
...
<style lang="scss">
    #slider{
        ...
        .handler_ok_bg{background:#fff url("data:image/png;base64,") no-repeat center;}
         .drag_bg{background-color:#00b7d3;height:40px;width:0px;}
        .drag_text{
            position:absolute;
            top:0px;
            width:100%;
